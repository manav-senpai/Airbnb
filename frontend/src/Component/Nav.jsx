...
function Nav() {
    ...
    const listingContext = useContext(listingDataContext)
    const { 
        listingData, 
        setListingData, 
        setNewListData, 
    ...
    const handleCategory = (category) => {
        ...
        // FIX: Always navigate to home when a category is clicked
        navigate("/");
    }
        ...
        <div className='fixed top-0 bg-[white] z-[20]'>
            <div className='w-[100vw] min-h-[80px] border-b-[1px] border-[#dcdcdc] px-[20px] flex items-center justify-between md:px-[40px] '>
                ...
                <div className='flex items-center justify-center gap-[10px] relative'>
                    {/* FIX: Added protection to the main "List your home" button */}
                    <span 
                        className='text-[18px] cursor-pointer rounded-[50px] hover:bg-[#ded9d9] px-[8px] py-[5px] hidden md:block' 
                        onClick={() => handleProtectedNavigation("/listingpage1")}
                    >
                        List your home
                    </span>
                    ...
                    {showpopup && (
                        <div className='w-[220px] h-[250px] absolute bg-slate-50 top-[110%] right-[3%] border-[1px] border-[#aaa9a9] z-10 rounded-lg md:right-[10%]'>
                            <ul className='w-[100%] h-[100%] text-[17px] flex items-start justify-around flex-col py-[10px]'>
                                ...
                                {/* FIX: Protected these links */}
                                <li className='w-[100%] px-[15px] py-[10px] hover:bg-[#f4f3f3] cursor-pointer' onClick={() => handleProtectedNavigation("/listingpage1")}>List your Home</li>
                                <li className='w-[100%] px-[15px] py-[10px] hover:bg-[#f4f3f3] cursor-pointer' onClick={() => handleProtectedNavigation("/mylisting")}>My Listing</li>
                                <li className='w-[100%] px-[15px] py-[10px] hover:bg-[#f4f3f3] cursor-pointer' onClick={() => handleProtectedNavigation("/mybooking")}>MY Booking</li>
                            </ul>
                        </div>
                    )}
                </div>
